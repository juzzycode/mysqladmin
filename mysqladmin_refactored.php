...
EOF;
    ...
    public function display() {
        ...
        if (isset($_POST['save']) && $this->validateCsrfToken()) {
            return $this->save();
        }
        if (isset($_POST['delete']) && !$this->nodelete && $this->validateCsrfToken()) {
            return $this->delete();
        }
        if (isset($_GET['move'])) {
            return $this->move();
        ...
        if (isset($_POST['add']) && !$this->disableadd && $this->validateCsrfToken()) {
            return $this->add();
        }
    ...
    private function save() {
        ...
        try {
            ...
            return '<div class="success">Entry saved.</div>';
        } catch (PDOException $e) {
            return '<div class="error">Database error: ' . $this->sanitize($e->getMessage()) . '</div>';
        }
    }
